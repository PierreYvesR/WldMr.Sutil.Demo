...
module Monaco =
    ...
    //         and write a Monaco.IDisposable to
    //         System.IDisposable inerface
    ...
    let [<Import("KeyMod","monaco-editor")>] KeyMod: Monaco.KeyModStatic = jsNative
    ...
    module Editor =
        ...
        type IStandaloneThemeData =
          {
            ``base``: BuiltinTheme
            ``inherit``: bool
            rules: ResizeArray<ITokenThemeRule>
            encodedTokensColors: ResizeArray<string> option
            colors: IColors
          }
        ...
        type IActionDescriptor = {
            ...
            keybindings: ResizeArray<int>  option
            /// The keybinding rule (condition on top of precondition).
            keybindingContext: string option
            ...
            contextMenuGroupId: string option
            /// Control the order in the context menu group.
            contextMenuOrder: float option
            ...
            run: (ICodeEditor * obj option[]) -> U2<unit, Promise<unit>>
        }
        ...
        type [<AllowNullLiteral>] ITextModel =
            ...
            abstract onDidChangeAttached: listener: (unit -> unit) -> IDisposable
        ...
        type [<AllowNullLiteral>] IComputedEditorOptions =
            ...
            abstract notImplemented: unit -> unit
        ...
        type [<AllowNullLiteral>] IEditorOption<'K1, 'V> =
            ...
            abstract applyUpdate: value: 'V * update: 'V -> ApplyUpdateResult<'V>
        ...
        type [<AllowNullLiteral>] IUnicodeHighlightOptions =
            ...
            // abstract allowedCharacters: Record<string, obj> option with get, set
        ...
        type [<AllowNullLiteral>] IGuidesOptions =
            ...
            /// Defaults to true.
            abstract highlightActiveIndentation: bool option with get, set
        ...
        type [<AllowNullLiteral>] ICodeEditor =
            ...
            abstract onDidChangeModelContent: IEvent<IModelContentChangedEvent> with get, set
            /// <summary>An event emitted when the language of the current model has changed.</summary>
            abstract onDidChangeModelLanguage: IEvent<IModelLanguageChangedEvent> with get, set
            /// <summary>An event emitted when the language configuration of the current model has changed.</summary>
            abstract onDidChangeModelLanguageConfiguration: IEvent<IModelLanguageConfigurationChangedEvent> with get, set
            /// <summary>An event emitted when the options of the current model has changed.</summary>
            abstract onDidChangeModelOptions: IEvent<IModelOptionsChangedEvent> with get, set
            /// <summary>An event emitted when the configuration of the editor has changed. (e.g. <c>editor.updateOptions()</c>)</summary>
            abstract onDidChangeConfiguration: IEvent<ConfigurationChangedEvent> with get, set
            /// <summary>An event emitted when the cursor position has changed.</summary>
            abstract onDidChangeCursorPosition: IEvent<ICursorPositionChangedEvent> with get, set
            /// <summary>An event emitted when the cursor selection has changed.</summary>
            abstract onDidChangeCursorSelection: IEvent<ICursorSelectionChangedEvent> with get, set
            /// <summary>An event emitted when the model of this editor has changed (e.g. <c>editor.setModel()</c>).</summary>
            abstract onDidChangeModel: IEvent<IModelChangedEvent> with get, set
            /// <summary>An event emitted when the decorations of the current model have changed.</summary>
            abstract onDidChangeModelDecorations: IEvent<IModelDecorationsChangedEvent> with get, set
            ...
            abstract onDidPaste: IEvent<IPasteEvent> with get, set
            /// <summary>An event emitted on a "mouseup".</summary>
            abstract onMouseUp: IEvent<IEditorMouseEvent> with get, set
            /// <summary>An event emitted on a "mousedown".</summary>
            abstract onMouseDown: IEvent<IEditorMouseEvent> with get, set
            /// <summary>An event emitted on a "contextmenu".</summary>
            abstract onContextMenu: IEvent<IEditorMouseEvent> with get, set
            /// <summary>An event emitted on a "mousemove".</summary>
            abstract onMouseMove: IEvent<IEditorMouseEvent> with get, set
            /// <summary>An event emitted on a "mouseleave".</summary>
            abstract onMouseLeave: IEvent<IPartialEditorMouseEvent> with get, set
            /// <summary>An event emitted on a "keyup".</summary>
            abstract onKeyUp: IEvent<IKeyboardEvent> with get, set
            /// <summary>An event emitted on a "keydown".</summary>
            abstract onKeyDown: IEvent<IKeyboardEvent> with get, set
            /// <summary>An event emitted when the layout of the editor has changed.</summary>
            abstract onDidLayoutChange: IEvent<EditorLayoutInfo> with get, set
            /// <summary>An event emitted when the content width or content height in the editor has changed.</summary>
            abstract onDidContentSizeChange: IEvent<IContentSizeChangedEvent> with get, set
            /// <summary>An event emitted when the scroll in the editor has changed.</summary>
            abstract onDidScrollChange: IEvent<IScrollEvent> with get, set
            /// <summary>An event emitted when hidden areas change in the editor (e.g. due to folding).</summary>
            abstract onDidChangeHiddenAreas: IEvent<unit> with get, set
            /// Saves current view state of the editor in a serializable object.
            ...
            abstract getOption: id: EditorOption -> FindComputedEditorOptionValueById
        ...
        type [<AllowNullLiteral>] IExportsEditorOptions =
            ...
            abstract quickSuggestions: IEditorOption<EditorOption, obj option> with get, set
            ...
            // abstract unicodeHighlight: IEditorOption<EditorOption, Required<obj>> with get, set
    ...
    module Languages =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract registerLinkedEditingRangeProvider: languageId: string * provider: LinkedEditingRangeProvider -> IDisposable
            ...
            abstract registerCodeActionProvider: languageId: string * provider: CodeActionProvider * ?metadata: CodeActionProviderMetadata -> IDisposable
            ...
            abstract registerInlineCompletionsProvider: languageId: string * provider: InlineCompletionsProvider -> IDisposable
            /// Register an inlay hints provider.
            abstract registerInlayHintsProvider: languageId: string * provider: InlayHintsProvider -> IDisposable
        ...
        type [<AllowNullLiteral>] InlayHintsProvider =
            ...
            abstract provideInlayHints: model: Editor.ITextModel * range: Range * token: CancellationToken -> ProviderResult<ResizeArray<InlayHint>>
        ...
        module Css =
            ...
            type [<RequireQualifiedAccess>] CSSDataV1Version =
                | N1 = 10
                | N1_1 = 11
        ...
        module Html =
            ...
            type [<RequireQualifiedAccess>] HTMLDataV1Version =
                | N1 = 10
                | N1_1 = 11
